    ...
    <Modal onClose={onClose} title={nameForm}>
      ...
      >
        ...
        <label>
          Descrição (opcional)
          <textarea
            placeholder="Ex.: Estudar utilização do Robot Framework para criar um setup de testes."
            className="w-full"
            value={description}
        ...
        <InputCheckbox
          ...
          label="Marque a tarefa como importante"
        />
        <InputCheckbox
          isChecked={isCompleted}
          setChecked={setIsCompleted}
          label="Marque a tarefa como completada"
        />
